<template>
  <div class="forum-module" v-loading="loading">
        ...
        <el-table style="width:100%" :data="items"  stripe  @selection-change="checkIds">
            ...
            <el-table-column label="评价时间" prop="time" align="center"></el-table-column>
            <el-table-column label="评价商品"  prop="productName"  align="center"></el-table-column>
            <el-table-column label="评价人" prop="userName" align="center"></el-table-column>
             <el-table-column label="操作"  align="center" width="200">
                         <template slot-scope="scope">
                            <a class="t-order" title="查看/回复" @click="routerLink('/discussList/update','update',scope.row.id)" ></a>
...
export default {
  ...
  methods: {
    getItems() {
      //获取接口数据
      fetch.getDiscussList(this.params).then(res => {
