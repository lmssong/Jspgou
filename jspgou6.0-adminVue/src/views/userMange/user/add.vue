    ...
    <div class="forum-module" v-loading='loading'>
        ...
        <el-form label-width="160px" class="table-body" ref="form" :model="info" :rules="rules">
            <el-row class="form-group">
                ...
                <el-col :xs="24" :sm="24" :md="12" :lg="12">
                    <el-form-item label="会员组" :required="true">
                ...
                <el-col :xs="24" :sm="24" :md="12" :lg="12">
                    <el-form-item label="积分" :required="true">
        ...
        .then(
          axios.spread(
            (
              ...
              this.workSeniorityIdList = this.creatGroup(workSeniorityIdList.body);
              this.familyMembersIdList = this.creatGroup(familyMembersIdList.body);
